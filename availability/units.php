            ...
            <table class="table">
                <thead>
                    <tr class="filters">
                        ...
                        <th><input type="text" class="form-control" placeholder="Beds" disabled></th>
                        <th><input type="text" class="form-control" placeholder="Baths" disabled></th>
                        <th><input type="text" class="form-control" placeholder="Square Footage" disabled></th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
